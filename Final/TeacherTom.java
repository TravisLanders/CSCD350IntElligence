...
public class TeacherTom extends Teacher
{
	...
	{
		super("Tom",new CostumeOptometrist(),null,new Weapon());
        ...
        this.quotes[1] = "Well looks like team IntElligence whens the steak!";
        this.quotes[2] = "For todays lecture we will be listening to the musical stylings of Mac Sabbath";
        this.quotes[3] = "I dont always make a home brew but when I do I make Hopolopagus IPAs staty thirsy my class";
	}
